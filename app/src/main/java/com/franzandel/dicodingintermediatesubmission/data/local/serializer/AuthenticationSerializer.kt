...
object AuthenticationSerializer : Serializer<AuthenticationSession> {
...
val Context.authenticationDataStore: DataStore<AuthenticationSession> by dataStore(
    fileName = "authentication_data_store.pb",
